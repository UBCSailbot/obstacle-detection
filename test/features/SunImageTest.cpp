...
TEST(SunImageTest, FindSunPositive) {
    ...
    EXPECT_EQ(sunImage.getSunPosition(), cv::Point2f(37, 37));
}
...
TEST(SunImageTest, FindSunNegative) {
    ...
    EXPECT_EQ(sunImage.getSunPosition(), cv::Point2f());
}
...
TEST(SunImageTest, FindColumn0Pix) {
    ...
    EXPECT_EQ(sunImage.getGlintLeftMargin().getStartPoint(), cv::Point2f());
    EXPECT_EQ(sunImage.getGlintLeftMargin().getEndPoint(), cv::Point2f());
    EXPECT_EQ(sunImage.getGlintRightMargin().getStartPoint(), cv::Point2f());
    EXPECT_EQ(sunImage.getGlintRightMargin().getEndPoint(), cv::Point2f());
}
...
TEST(SunImageTest, FindColumnPixAboveHorizon) {
    ...
    EXPECT_EQ(sunImage.getGlintLeftMargin().getStartPoint(), cv::Point2f(20, 0));
    EXPECT_EQ(sunImage.getGlintLeftMargin().getEndPoint(), cv::Point2f(20, 59));
    EXPECT_EQ(sunImage.getGlintRightMargin().getStartPoint(), cv::Point2f(20, 0));
    EXPECT_EQ(sunImage.getGlintRightMargin().getEndPoint(), cv::Point2f(20, 59));
}
...
TEST(SunImageTest, FindColumnPixBelowFlatHorizonWithSun) {
    ...
    EXPECT_NE(sunImage.getGlintLeftMargin().getStartPoint(), cv::Point2f(53, 0));
    EXPECT_NE(sunImage.getGlintLeftMargin().getEndPoint(), cv::Point2f(53, 59));
    EXPECT_NE(sunImage.getGlintRightMargin().getStartPoint(), cv::Point2f(55, 0));
    EXPECT_NE(sunImage.getGlintRightMargin().getEndPoint(), cv::Point2f(55, 59));
}
...
TEST(SunImageTest, FindColumnPixBelowFlatHorizon) {
    ...
    EXPECT_EQ(sunImage.getGlintLeftMargin().getStartPoint(), cv::Point2f(53, 0));
    EXPECT_EQ(sunImage.getGlintLeftMargin().getEndPoint(), cv::Point2f(53, 59));
    EXPECT_EQ(sunImage.getGlintRightMargin().getStartPoint(), cv::Point2f(55, 0));
    EXPECT_EQ(sunImage.getGlintRightMargin().getEndPoint(), cv::Point2f(55, 59));
}
...
TEST(SunImageTest, FindColumnPixBelowDiagHorizon) {
    ...
    EXPECT_FLOAT_EQ(sunImage.getGlintLeftMargin().getStartPoint().x,  67.43037975);
    EXPECT_FLOAT_EQ(sunImage.getGlintLeftMargin().getEndPoint().x,  52.49367089);
    EXPECT_FLOAT_EQ(sunImage.getGlintRightMargin().getStartPoint().x,  68.16455696);
    EXPECT_FLOAT_EQ(sunImage.getGlintRightMargin().getEndPoint().x,  53.2278481);
}
