...
using namespace std;
 ...
 int main( int argc, char** argv )
 {
	...
	String path = "/home/josh/SailbotOpenCV/data/betterbuoy.avi";
    ...
    namedWindow("Obstacles", CV_WINDOW_NORMAL); //create a window called "Control"
    namedWindow("Threshold", CV_WINDOW_NORMAL); //create a window called "Control"
    namedWindow("Threshold1", CV_WINDOW_NORMAL); //create a window called "Control"
    namedWindow("Threshold2", CV_WINDOW_NORMAL); //create a window called "Control"
    namedWindow("Threshold3", CV_WINDOW_NORMAL); //create a window called "Control"
    namedWindow("Threshold4", CV_WINDOW_NORMAL); //create a window called "Control"
