...
string base64_encode(Image8bit img) {
    string ret;
    string stringImg = convert8BitImgToString(img);
//    unsigned char const*  bytes_to_encode = (const unsigned char *)stringImg.c_str();
//    unsigned int in_len = stringImg.length();
//
//    string ret;
//    int i = 0;
//    int j = 0;
