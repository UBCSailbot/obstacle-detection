...
Horizon HorizonFactory::makeHorizon(Orientation o) {
...
double HorizonFactory::pitchHorizonPixelShift(double angle, ICameraSpecifications spec){
    return angle / (spec.FOVDegreesVertical * M_PI / 180.0) * spec.pixelHeight;
}

double HorizonFactory::rollHorizonPixelShift(double angle, ICameraSpecifications spec) {
